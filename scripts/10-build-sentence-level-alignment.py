...
def build_sentence_alignment_for_all_events(args, subset):
  events_dir = reduced_dataset_dir(args.data_dir) / '05-word-level-alignment' / subset
  sentence_alignment_dir = reduced_dataset_dir(args.data_dir) / '07-sentence-level-alignment' / subset
...
def build_sentence_alignment_for_audio_file(args, event, word_alignment_file_path, target_dir, subset):
  ...
  transcript_file_path = reduced_dataset_dir(args.data_dir) / '04-audio-level-pairs' / subset / event / f'{audio_base_name}.tsv'
